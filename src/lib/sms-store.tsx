...
const initialRecords: SmsRecord[] = [
  ...
  },
  {
    ...
    succeededAt: ts(79),
    failReason: null,
    reply: "¿El 50% de descuento incluye el envío a Canarias?",
    replyZh: "5 折优惠包含寄往加那利群岛的运费吗？",
    replyAt: ts(66),
  },
  {
    id: "r4",
  ...
  // ===== 商机演示数据：覆盖 未读待跟进 / 已读无需跟进 / 我方已回复 等场景 =====
  {
    id: "r10",
    targetId: "t3",
    taskId: "task3",
    ...
    seq: 2,
    status: "delivered",
    content: "[AirHui] Sure Emma, the AirMax line is available in UK sizes 3-9. Order here: airhui.shop/promo",
    contentZh: "【信汇】Emma，AirMax 跨境直邮专线英码 3-9 均有现货，下单：airhui.shop/promo",
    credits: 12,
    createdAt: ts(68),
    succeededAt: ts(67),
    failReason: null,
    reply: "Is UK 5 still in stock? I'd like two pairs.",
    replyZh: "英码 5 还有货吗？我想要两双。",
    replyAt: ts(61),
  },
  {
    id: "r10a",
    ...
    succeededAt: ts(71),
    failReason: null,
    reply: "Do you have this in UK sizes?",
    replyZh: "这款有英码的吗？",
    replyAt: ts(70),
    replyRead: true,
  },
  {
    ...
    seq: 1,
    status: "delivered",
    content: "[AirHui] Ahmed, 30 off your first order on the AirMax cross-border line. Shop now: airhui.shop",
    contentZh: "【信汇】Ahmed，首单立减 30 元，AirMax 跨境直邮专线限时开启，点击 airhui.shop 抢购 →",
    credits: 12,
    createdAt: ts(52),
    succeededAt: ts(51),
    failReason: null,
    reply: "شكرًا، لا أحتاج حاليًا. توقف عن الإرسال من فضلك.",
    replyZh: "谢谢，目前不需要，请不要再发送了。",
    replyAt: ts(47),
    replyRead: true,
  },
  {
    ...
    status: "delivered",
    content:
      "[AirHui] 민준님, 첫 주문 30위안 할인! AirMax 크로스보더 직배송 한정 오픈, airhui.shop 에서 확인 →",
    contentZh: "【信汇】Min-jun，首单立减 30 元，AirMax 跨境直邮专线限时开启，点击 airhui.shop 抢购 →",
    credits: 15,
    createdAt: ts(40),
    succeededAt: ts(39),
    failReason: null,
    reply: "배송 기간이 얼마나 걸리나요? 제주도도 배송 되나요?",
    replyZh: "配送需要多长时间？济州岛也能送吗？",
    replyAt: ts(34),
  },
  {
    id: "r13",
    ...
    seq: 2,
    status: "delivered",
    content: "[AirHui] Hi Olivia, GST is included and shipping to AU is free over $59. Details: airhui.shop/promo",
    contentZh: "【信汇】Olivia，价格已含 GST，满 59 美元澳洲免运费。详情：airhui.shop/promo",
    credits: 12,
    createdAt: ts(28),
    succeededAt: ts(27),
    failReason: null,
    reply: "Great, does the free shipping apply to NZ addresses too?",
    replyZh: "太好了，免运费也适用于新西兰地址吗？",
    replyAt: ts(20),
  },
  {
    id: "r13a",
    ...
    succeededAt: ts(35),
    failReason: null,
    reply: "Does the price include GST?",
    replyZh: "价格包含消费税（GST）吗？",
    replyAt: ts(32),
    replyRead: true,
  },
  {
    ...
    seq: 2,
    status: "delivered",
    content: "【信汇】王伟，立减券已发放至您的账户，下单时自动抵扣，无需输入优惠码。",
    contentZh: null,
    credits: 12,
    createdAt: ts(24),
    succeededAt: ts(23),
  ...
  },
  {
    ...
    seq: 1,
    status: "delivered",
    content: "【信汇】王伟，首单立减 30 元，AirMax 跨境直邮专线限时开启，点击 airhui.shop 抢购 →",
    contentZh: null,
    credits: 18,
    createdAt: ts(46),
    succeededAt: ts(45),
  ...
  },
  {
    ...
    seq: 1,
    status: "delivered",
    content: "[AirHui] Hi Wei Ling, 30 off your first order on the AirMax line. Limited time: airhui.shop",
    contentZh: "【信汇】Wei Ling，首单立减 30 元，AirMax 跨境直邮专线限时开启，点击 airhui.shop 抢购 →",
    credits: 15,
    createdAt: ts(18),
    succeededAt: ts(17),
    failReason: null,
    reply: "Interested. Do you ship to Singapore within 3 days?",
    replyZh: "有兴趣，新加坡能 3 天内送达吗？",
    replyAt: ts(12),
  },
  {
    id: "r16",
    ...
    seq: 1,
    status: "delivered",
    content: "[AirHui] Анастасия, скидка 30 юаней на первый заказ. Прямая доставка AirMax: airhui.shop",
    contentZh: "【信汇】Anastasia，首单立减 30 元，AirMax 跨境直邮专线限时开启，点击 airhui.shop 抢购 →",
    credits: 15,
    createdAt: ts(15),
    succeededAt: ts(14),
    failReason: null,
    reply: "Спасибо, пока не интересно.",
    replyZh: "谢谢，暂时不感兴趣。",
    replyAt: ts(10),
    replyRead: true,
  },
  {
    ...
    seq: 1,
    status: "delivered",
    content: "[AirHui] Pedro, 30 de desconto no primeiro pedido. Linha AirMax por tempo limitado: airhui.shop",
    contentZh: "【信汇】Pedro，首单立减 30 元，AirMax 跨境直邮专线限时开启，点击 airhui.shop 抢购 →",
    credits: 15,
    createdAt: ts(8),
    succeededAt: ts(7),
    failReason: null,
    reply: "Quero comprar 10 pares para revenda. Tem preço de atacado?",
    replyZh: "我想买 10 双转售，有批发价吗？",
    replyAt: ts(5),
  },
];
