  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">该页面可能已被移动或删除。</p>
        <div className="mt-6">
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">请刷新重试，或返回首页。</p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "短信营销管理系统 | 信汇 SMS Console" },
      {
        name: "description",
        content: "面向跨境电商的短信营销管理系统：目标管理、任务下发、发送明细与模板变量。",
      },
